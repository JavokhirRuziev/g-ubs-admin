...
Filter = withFormik({
    ...
    mapPropsToValues: ({ location }) => {
        ...
        return ({
            ...
            category_id: params.category_id ? {id: params.category_id.split('/')[0], title: params.category_id.split('/')[1] } : null
        })
    ...
    handleSubmit: (values, { props: { location, history, showFilterModal } }) => {
        ...
        values = {
            ...
            category_id: values.category_id ? values.category_id.id+'/'+get(values, 'category_id.title') : '',
        };
