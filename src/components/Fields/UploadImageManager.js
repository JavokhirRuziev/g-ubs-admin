...
const UploadImageManager = ({useFileName=0,useFolderPath,columns=12, isMulti, isDocument = false, limit = 1, label, field, form: {touched, errors, setFieldValue, values}, className}) => {
