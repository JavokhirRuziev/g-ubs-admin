...
export class All extends Component {
	...
	componentDidMount(){
		const { entity, name, url, params, dataKey, metaKey, appendData, prependData, initialLoad, primaryKey, relations, infiniteScroll, onSuccess, onError } = this.props;
		if(initialLoad){
	...
	componentDidUpdate(prevProps){
		const { entity, name, url, params, dataKey, metaKey, appendData, prependData, primaryKey, relations, infiniteScroll, onSuccess, onError, canUpdate } = this.props;
		if(!isEqual(url, prevProps.url) || !isEqual(params, prevProps.params) || !isEqual(canUpdate, prevProps.canUpdate)){
			this.Load(entity, name, url, params, dataKey, metaKey, appendData, prependData, primaryKey, relations, infiniteScroll, onSuccess, onError);
		}
	}
